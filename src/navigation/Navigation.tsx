...
import { setCurrentUser, setLoading, toggleDarkMode, toggleFirstOpen } from '~/redux/action/appActions';
        ...
        <>
            {appReducer.isLoading ?
                ...
                <NavigationContainer
                    ...
                    {appReducer.currentUser ? <MainTabs state={appReducer} routeName={routeName} /> : <AuthStack state={appReducer} />}
                </NavigationContainer>
            }
        </>
    );
